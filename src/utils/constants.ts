...
export const CREATE_ATTACHMENTS_TABLE = `CREATE TABLE IF NOT EXISTS attachments (id text NOT NULL,  message_id text NOT NULL, path text NOT NULL, filename text NOT NULL, date bigint NOT NULL)`;
